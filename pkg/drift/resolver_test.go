...
func TestFindControllerManager(t *testing.T) {
	tests := []struct {
		...
		{
			name: "Crossplane-style: manager owns Synced condition observedGeneration",
			managedFields: []metav1.ManagedFieldsEntry{
				{
					Manager:     "crossplane",
					Operation:   metav1.ManagedFieldsOperationUpdate,
					Subresource: "status",
					FieldsV1: &metav1.FieldsV1{
						Raw: []byte(`{"f:status":{"f:conditions":{"k:{\"type\":\"Synced\"}":{"f:observedGeneration":{}}}}}`),
					},
				},
			},
			wantManager: "crossplane",
		},
		{
			name: "Crossplane-style: manager owns Ready condition observedGeneration",
			managedFields: []metav1.ManagedFieldsEntry{
				{
					Manager:     "crossplane",
					Operation:   metav1.ManagedFieldsOperationUpdate,
					Subresource: "status",
					FieldsV1: &metav1.FieldsV1{
						Raw: []byte(`{"f:status":{"f:conditions":{"k:{\"type\":\"Ready\"}":{"f:observedGeneration":{}}}}}`),
					},
				},
			},
			wantManager: "crossplane",
		...
		{
			name: "prefers top-level observedGeneration over condition",
			managedFields: []metav1.ManagedFieldsEntry{
				{
					Manager:     "standard-controller",
					Operation:   metav1.ManagedFieldsOperationUpdate,
					Subresource: "status",
					FieldsV1: &metav1.FieldsV1{
						Raw: []byte(`{"f:status":{"f:observedGeneration":{}}}`),
			...
			wantManager: "standard-controller",
		},
	}
